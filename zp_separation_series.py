...
if __name__ == "__main__":
    ...
    for i_repeat in range(0, 1):
        t = ImageSeriesSeparation('input1', 'input2', input1, input2, num_iter=10000,
                                output_folder='zp_series/output_multislice_constant_alpha_1e-1_rep{}/'.format(i_repeat), learning_rate=1e-3,
                                input_type='noise', gamma_excl=1e-1, gamma_reg=0.5, device=device)
        t.optimize()
        t.finalize()
